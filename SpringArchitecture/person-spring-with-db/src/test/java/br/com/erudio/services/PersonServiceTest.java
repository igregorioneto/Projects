...
public class PersonServiceTest {
    ...
    void testCreateWithNullPerson() {
        Exception exception = assertThrows(RequireObjectsNullException.class, () -> {
    ...
    void testFindAll() {
        ...
        assertNotNull(personsVO);
        assertEquals(14, personsVO.size());

        var personOne = personsVO.get(1);
        ...
        var personFour = personsVO.get(4);
        ...
        var personSeven = personsVO.get(7);
