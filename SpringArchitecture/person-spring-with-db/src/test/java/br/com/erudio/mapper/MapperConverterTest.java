...
public class MapperConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = VoMapper.parseListObjects(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parseVoToEntityTest() {
        Person person = VoMapper.parseObject(inputObject.mockVO(), Person.class);
    ...
    public void parseEntityToVOTest() {
        PersonVO personVO = VoMapper.parseObject(inputObject.mockEntity(), PersonVO.class);
        ...
        assertEquals("Addres Test0", personVO.getAddress());
        assertEquals("Male", personVO.getGender());
    }

    @Test
    public void parserVOListToEntityListTest() {
        List<Person> outputList = VoMapper.parseListObjects(inputObject.mockVOList(), Person.class);
